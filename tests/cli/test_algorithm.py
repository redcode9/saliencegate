...
def test_algorithm_cli_help_contract_is_exact(run_cli: RunCli) -> None:
    ...
    assert root.stdout == (
        ...
        "                    {demo,doctor,connect,disconnect,status,sessions,report,delete,"
        "replay,shadow,algorithm,pilot,benchmark,inspect,validate}\n"
        "                    ...\n"
        "\n"
        "positional arguments:\n"
        "  {demo,doctor,connect,disconnect,status,sessions,report,delete,replay,shadow,"
        "algorithm,pilot,benchmark,inspect,validate}\n"
