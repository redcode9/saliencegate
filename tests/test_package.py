...
BASELINE_PACKAGE_MEMBERS = {
    "saliencegate/__init__.py",
    "saliencegate/__main__.py",
    "saliencegate/adapters/__init__.py",
    "saliencegate/adapters/generic.py",
    "saliencegate/adapters/jsonl.py",
    "saliencegate/artifacts/__init__.py",
    "saliencegate/artifacts/algorithm_export.py",
    "saliencegate/artifacts/algorithm_manifest.py",
    "saliencegate/artifacts/algorithm_projection.py",
    "saliencegate/artifacts/algorithm_validate.py",
    "saliencegate/artifacts/exclusive.py",
    "saliencegate/artifacts/export.py",
    "saliencegate/artifacts/manifest.py",
    "saliencegate/artifacts/tree.py",
    "saliencegate/artifacts/validate.py",
    "saliencegate/benchmarks/__init__.py",
    "saliencegate/benchmarks/registry.py",
    "saliencegate/benchmarks/state_decay/__init__.py",
    "saliencegate/benchmarks/state_decay/diagnostic.py",
    "saliencegate/benchmarks/state_decay/generator.py",
    "saliencegate/benchmarks/state_decay/oracle.py",
    "saliencegate/benchmarks/state_decay/runner.py",
    "saliencegate/benchmarks/state_decay/schema.py",
    "saliencegate/benchmarks/state_decay_v2/__init__.py",
    "saliencegate/benchmarks/state_decay_v2/authority.py",
    "saliencegate/benchmarks/state_decay_v2/config.py",
    "saliencegate/benchmarks/state_decay_v2/generation_authority.py",
    "saliencegate/benchmarks/state_decay_v2/generator.py",
    "saliencegate/benchmarks/state_decay_v2/manifest.py",
    "saliencegate/benchmarks/state_decay_v2/preallocation.py",
    "saliencegate/benchmarks/state_decay_v2/protocol.py",
    "saliencegate/benchmarks/state_decay_v2/public_catalog.py",
    "saliencegate/benchmarks/state_decay_v2/public_contract.py",
    "saliencegate/benchmarks/state_decay_v2/review.py",
    "saliencegate/benchmarks/state_decay_v2/review_cli.py",
    "saliencegate/benchmarks/state_decay_v2/review_contract.py",
    "saliencegate/benchmarks/state_decay_v2/review_io.py",
    "saliencegate/benchmarks/state_decay_v2/review_pack.py",
    "saliencegate/benchmarks/state_decay_v2/schema.py",
    "saliencegate/benchmarks/state_decay_v2/signal_fixtures.py",
    "saliencegate/benchmarks/state_decay_v2/templates.py",
    "saliencegate/cli.py",
    "saliencegate/commands/__init__.py",
    "saliencegate/commands/algorithm.py",
    "saliencegate/commands/demo.py",
    "saliencegate/commands/doctor.py",
    "saliencegate/commands/inspect.py",
    "saliencegate/commands/pilot.py",
    "saliencegate/commands/replay.py",
    "saliencegate/commands/shadow.py",
    "saliencegate/commands/validate.py",
    "saliencegate/domain/__init__.py",
    "saliencegate/domain/enums.py",
    "saliencegate/domain/errors.py",
    "saliencegate/domain/ids.py",
    "saliencegate/domain/records.py",
    "saliencegate/domain/serde.py",
    "saliencegate/domain/validation.py",
    "saliencegate/experiments/__init__.py",
    "saliencegate/experiments/conditions.py",
    "saliencegate/experiments/evidence.py",
    "saliencegate/experiments/retrieval.py",
    "saliencegate/experiments/runner.py",
    "saliencegate/experiments/trajectory.py",
    "saliencegate/intervention/__init__.py",
    "saliencegate/intervention/claims.py",
    "saliencegate/intervention/grounding.py",
    "saliencegate/intervention/rendering.py",
    "saliencegate/intervention/versions.py",
    "saliencegate/memory/__init__.py",
    "saliencegate/memory/materialize.py",
    "saliencegate/memory/proposals.py",
    "saliencegate/memory/two_phase.py",
    "saliencegate/models/__init__.py",
    "saliencegate/models/openai_compatible.py",
    "saliencegate/models/replay.py",
    "saliencegate/models/replay_two_phase.py",
    "saliencegate/observability.py",
    "saliencegate/policy/__init__.py",
    "saliencegate/policy/config.py",
    "saliencegate/policy/trigger.py",
    "saliencegate/ports/__init__.py",
    "saliencegate/ports/adapters.py",
    "saliencegate/ports/memory.py",
    "saliencegate/ports/model_calls.py",
    "saliencegate/ports/models.py",
    "saliencegate/ports/outcomes.py",
    "saliencegate/ports/repository.py",
    "saliencegate/ports/trajectory.py",
    "saliencegate/ports/two_phase.py",
    "saliencegate/prompts/__init__.py",
    "saliencegate/prompts/contracts.py",
    "saliencegate/prompts/paper_two_phase_v1.py",
    "saliencegate/py.typed",
    "saliencegate/repository/__init__.py",
    "saliencegate/repository/integrity.py",
    "saliencegate/repository/memory.py",
    "saliencegate/repository/migrations/0001_initial.sql",
    "saliencegate/repository/migrations/0002_unique_invocation_event.sql",
    "saliencegate/repository/migrations/__init__.py",
    "saliencegate/repository/projector.py",
    "saliencegate/repository/sqlite.py",
    "saliencegate/runtime/__init__.py",
    "saliencegate/runtime/algorithm_result.py",
    "saliencegate/runtime/batching.py",
    "saliencegate/runtime/budget.py",
    "saliencegate/runtime/cycles.py",
    "saliencegate/runtime/delivery.py",
    "saliencegate/runtime/engine.py",
    "saliencegate/runtime/fixed_step.py",
    "saliencegate/runtime/fixed_step_core.py",
    "saliencegate/runtime/message_window.py",
    "saliencegate/runtime/model_token_counting.py",
    "saliencegate/runtime/scheduling.py",
    "saliencegate/runtime/token_counting.py",
    "saliencegate/security/__init__.py",
    "saliencegate/security/digests.py",
    "saliencegate/security/files.py",
    "saliencegate/security/keys.py",
    "saliencegate/security/redaction.py",
    ...
    "saliencegate/signals/__init__.py",
    "saliencegate/signals/base.py",
    "saliencegate/signals/fingerprints.py",
    "saliencegate/signals/repetition.py",
    "saliencegate/signals/test_failures.py",
    "saliencegate/signals/tool_errors.py",
}
...
CAPTURE_RUNTIME_FILES = {
    ...
    "saliencegate/capture/feedback.py",
    ...
    "saliencegate/capture/transport.py",
    ...
    "saliencegate/commands/capture/feedback.py",
...
def test_source_package_preserves_all_baseline_members() -> None:
    runtime = {
    ...
    assert len(BASELINE_PACKAGE_MEMBERS) == 141
    assert runtime >= BASELINE_PACKAGE_MEMBERS
...
def test_built_wheel_has_exact_runtime_membership_and_payloads(
    ...
    assert files.keys() >= BASELINE_PACKAGE_MEMBERS
