...
non-gating 250-to-1,000 median-time ratios were 5.165217537709454 in memory and
5.2514702274464575 with SQLite; the v1 prefix digest is not claimed to scale linearly.
